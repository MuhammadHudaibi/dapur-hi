...
const features = [
  ...
  },
  {
    ...
    description: "Porsi makanan dijamin cukup dan memuaskan.",
  },
];
...
const CateringSection = () => {
  ...
  return (
    <section
      id="katering"
      ref={sectionRef}
      className="fade-in-section bg-white py-20 px-4 sm:px-6 lg:px-8"
    >
      <div className="max-w-5xl mx-auto">
        ...
        <div className="text-center">
          <h3 className="text-lg font-semibold text-orange-500 font-poppins">
